...
if (theForm3.about.value == ""||theForm3.note.about.length < 10) {
    alert( "Enter about us  more than 10 charcter please" );
    theForm3.about.focus();
    return false;
}
if (theForm3.vision.value == ""||theForm3.vision.about.length < 10) {
    alert( "Enter about us  more than 10 charcter please" );
    theForm3.vision.focus();
    return false;
}
if (theForm3.location.value == ""||theForm3.location.about.length < 10) {
    alert( "Enter about us  more than 10 charcter please" );
